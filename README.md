...
В ветке extra реализованы дополнительные функции:
1) Команда touch - создание файлов (поддерживается >1 аргумента)


2) Команда bc - интеграция прошлой лабораторной №1 с созданием калькулятора на RPN. При вводе вида "bc <exp>" - выражение вычисляется так и пишется результат,
но если просто ввести bc, то запускается интерактивный режим и поддерживается выход сочетанием клавиш Ctrl+C/Ctrl+D
